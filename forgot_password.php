    ...
    <div class="lg:w-1/3 md:w-4/5 w-4/5 shadow-2xl bg-white p-6 rounded-4xl">
      ...
      <?php else: ?>
        ...
        <form method="POST" action="" class="space-y-4 mt-4">
          <input type="email" name="email" placeholder="Email Anda" required class="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400">
          ...
          <!-- PASS 2  -->
          <div class="relative">
            <input id="password2" type="password" name="password2" placeholder="Password" required class="w-full p-3 border border-gray-300 rounded-md pr-12 focus:outline-none focus:ring-2 focus:ring-blue-400" />
